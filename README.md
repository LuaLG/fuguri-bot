# Fire Emblem Heroes Summoning Simulation Bot

<img src="https://img.shields.io/badge/progress-0%25-red.svg"> &nbsp; <img src="https://img.shields.io/badge/bot%20version-0.0.0-BC57B4.svg"> &nbsp; <img src="https://img.shields.io/badge/npm-5.8.0-1ABC9C.svg"> &nbsp; <img src="https://img.shields.io/badge/node-8.11.1-E91E63.svg">
...
### Created Commands
* balance = displays the user's current orb balance (not finished yet)
* daily = Adds the daily log-in bonus of 200 orbs to the user's total orb count (not finished yet)
* herofetch = Fetches the latest hero information from the API. (%)
* reply = Test command, replies with "Hi, I'm awake!"
* summon = Summons a hero based on the color of orb chosen (not finished yet)
...
## Credits
* [AnIdiotsGuide](https://anidiotsguide_old.gitbooks.io/discord-js-bot-guide/) for the points system code.
